			...
			>
				<div>
					...
					<p class="mt-1 text-gray-900">
						...
						purposes, this equates to 'pages') free per month, and the cost of additional 'units' is
						${1.5 / 1000}. Assuming you're not using cloud vision credits anywhere else with your
						GCP account, this is almost certainly the cheapest option, and in most cases will be
			...
			>
				<div>
					...
					<p class="mt-1 text-gray-900">
						...
						expensive at ${(7.5 * 300) / 1000000}). An average user uploading 3 pages per day can
						expect to pay around ${3 * 30 * (0.003825 + 0.00225 + 0.00075)} per month depending on handwriting
						density. Note that automated summaries, keyword generation, and 'chat with my notes' is only
						available using ChatGPT.
					</p>
				</div>
