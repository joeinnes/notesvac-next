// Thanks to https://github.com/easybird (https://github.com/easybird/json-to-frontmatter-markdown)
type TFrontMatter = {
...
function transformMarkdownKeyValueToString(key, value, markdownString, depth = 0) {
	try {
